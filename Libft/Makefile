...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/10/29 12:46:55 by amohamed          #+#    #+#              #
#    Updated: 2018/10/29 12:46:56 by amohamed         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_int_len.c \
ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c\
ft_w_count.c ft_isspace.c
